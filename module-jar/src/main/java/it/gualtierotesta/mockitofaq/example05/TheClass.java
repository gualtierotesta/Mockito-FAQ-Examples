...
public abstract class TheClass {
    ...
    public String loggerUsersMessage() {
        String res;
        int num = getDependency().countLoggedUsers();
        switch (num) {
            case 0:
        ...
        // Note the use of the abstract method
        return serviceName() + res;
    }

    public void setDependency(final ADependency pDependency) {
